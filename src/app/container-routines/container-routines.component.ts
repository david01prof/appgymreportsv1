...
import { ChartRoutinesComponent } from "./components/chart-routines/chart-routines.component";
import { RoutinesPrimeModule } from './routines-prime.module';
...
export class ContainerRoutinesComponent {
  ...
  constructor(){
    effect(() => {
      ...
      // console.log(this.store.routines());
